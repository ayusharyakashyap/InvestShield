...
from app.models import ContentAnalysis, ContentAnalysisResponse
...
async def analyze_text(
    ...
    try:
        ...
        # If suspicious content detected, add to flagged content
        if analysis_result['is_suspicious'] and analysis_result['risk_score'] > 60:
...
async def analyze_url(
    ...
    try:
        ...
        analysis_result = content_service.analyze_text(clean_text[:2000], source)  # Limit to 2000 chars
        ...
        for i, text in enumerate(texts):
            ...
            try:
                ...
                if analysis_result['is_suspicious']:
                    ...
                    # Add to flagged content if high risk
                    if analysis_result['risk_score'] > 60:
                        dashboard_service.add_flagged_content({
                            'content': text,
